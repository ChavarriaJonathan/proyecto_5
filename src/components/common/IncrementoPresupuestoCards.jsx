...
const IncrementoPresupuestoCards = ({ selectedEscenario }) => {
  ...
  const handleSaveChanges = async () => {
    try {
      ...
      // Asegurarse de que los datos enviados tienen toda la información necesaria
      ...
      if (response.data.success) {
        ...
        // Esperar un momento antes de recargar los datos para asegurar que la BD se ha actualizado
        setTimeout(() => {
          fetchIncrementoData();
        }, 500);
      } else {
...
export default IncrementoPresupuestoCards;