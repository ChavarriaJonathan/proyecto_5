...
import IncrementoPresupuestoCards from './IncrementoPresupuestoCards';

const PresionDelGasto = () => {
  ...
  }, [selectedEscenario, selectedConvocatoria, sortOption]);
  ...
  const handleEscenarioSelect = (escenario) => {
    if (edited || aniosEdited) {
  ...
  const handleConvocatoriaFilter = (convocatoria) => {
    if (edited || aniosEdited) {
      if (window.confirm('Hay cambios sin guardar. ¿Deseas continuar sin guardar?')) {
  ...
  return (
    <div className="presion-gasto-container">
      <Sidebar 
        onEscenarioSelect={handleEscenarioSelect} 
        onConvocatoriaFilter={handleConvocatoriaFilter}
          ...
          <div className="tables-container">
            ...
            {convocatorias.length > 0 ? (
              <>
                ...
                <IncrementoPresupuestoCards selectedEscenario={selectedEscenario} />
              </>
            ) : (
...
export default PresionDelGasto;